...
import { signupValidationSchema, signinValidationSchema } from "./auth.validation.js";
import { validateSchema } from "../../middlewares/validateSchema.js";
import { isUserExist } from "../../middlewares/isUserExist.js";

const authRoutes = express.Router();
authRoutes.post(`/signup`, validateSchema(signupValidationSchema), isUserExist, signup);
